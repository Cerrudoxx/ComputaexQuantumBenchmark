...
def main():
    """The main function for running Grover's algorithm with Qibo."""
    ...
    times_file_name = f'Grover_data_qibo_{args.n}'
    ...
    for n in qubits_list:
        for num_iterations in iterations_list:
            results_handler.display_header("Grover", "Qibo", n, num_iterations, args.cores)
