...
def main():
    """The main function for running Grover's algorithm with Qulacs."""
    ...
    for n in qubits_list:
        num_iterations = 0  # Qulacs Grover doesn't use shot iterations
        results_handler.display_header("Grover", "Qulacs", n, num_iterations, args.cores)
