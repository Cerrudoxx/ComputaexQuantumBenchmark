...
def main():
    """The main function for running the QFT algorithm with Qsimov."""
    ...
    times_file_name = f'QFT_data_qsimov_{args.n}'
    ...
    for n in qubits_list:
        for num_iterations in iterations_list:
            results_handler.display_header("QFT", "Qsimov", n, num_iterations, args.cores)
