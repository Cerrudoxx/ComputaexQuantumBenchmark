...
class Runner:
    """A class to run the Quantum Fourier Transform (QFT) and measure its performance using Qibo.
    ...
    Attributes:
        ...
        circuit (Circuit): The Qibo circuit for the QFT.
    ...
    def _build_circuit(self) -> Circuit:
        """Builds the Qibo circuit for the QFT.

        Returns:
            Circuit: The Qibo circuit for the QFT.
        """
