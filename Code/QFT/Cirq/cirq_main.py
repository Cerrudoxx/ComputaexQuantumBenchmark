...
def main():
    """The main function for running the QFT algorithm with Cirq."""
    ...
    times_file_name = f'QFT_data_cirq_{args.n}'
    ...
    for n in qubits_list:
        for num_iterations in iterations_list:
            results_handler.display_header("QFT", "Cirq", n, num_iterations, args.cores)
