...
def main():
    """The main function for running the Quantum Volume algorithm with Qulacs."""
    parser = argparse.ArgumentParser(description="Run the Quantum Volume algorithm with a specified number of qubits")
    ...
    times_file_name = f'QV_data_qulacs_{args.n}'
    results_handler = ResultsHandler(times_file_name, results_dir, console)

    for n in qubits_list:
        console.print(f"Running Quantum Volume with {n} qubits and {args.cores} cores...", style="bright_magenta")
